...
if (!theWindow.opener) theWindow.opener=self;Text = '<form ';Text +='onSubmit="opener.location=this.password.value + \'.html\'; self.close();if (this.password.value == "test"){alert("good");} else {alert("bad");}">';
